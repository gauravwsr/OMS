...
const Employee = () => {
  ...
  const handleFinishFaceRegistration = async () => {
    ...
    try {
      ...
      const response = await axios.post("http://142.93.213.81:5001/register_face", {
      ...
      if (formData.candidateId) {
        try {
          const faceEncodingsResponse = await axios.put(
            `http://142.93.213.81:5001/api/candidates/${formData.candidateId}/face-encodings`,
            {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (!serverOnline) {
        alert(
          "❌ Backend server is not accessible. Please ensure the server is running on http://142.93.213.81:5001"
        );
        setLoading(false);
        setLoadingMessage("");
        return;
      ...
      if (error.code === "ECONNABORTED") {
        ...
        errorMessage =
          "Unable to connect to server. Please check if the backend server is running on http://142.93.213.81:5001";
            ...
            >
              ...
              >
                ...
                <li>
                  ...
                  <code>http://142.93.213.81:5001</code>
                </li>
                <li>
