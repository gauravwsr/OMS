...
const Employee = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (!serverOnline) {
        alert(
          "❌ Backend server is not accessible. Please ensure the server is running on http://138.197.27.240:5001"
        );
        setLoading(false);
        setLoadingMessage("");
        return;
      ...
      if (error.code === "ECONNABORTED") {
        ...
        errorMessage =
          "Unable to connect to server. Please check if the backend server is running on http://138.197.27.240:5001";
            ...
            >
              ...
              >
                ...
                <li>
                  ...
                  <code>http://138.197.27.240:5001</code>
                </li>
                <li>
