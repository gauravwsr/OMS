...
const ProjectManagerDashboard = () => {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        try {
          await fetch(
            "http://138.197.27.240:5001/api/client-projects/import-remote",
            {
              method: "POST",
              headers: {
        ...
        const response = await fetch(
          "http://138.197.27.240:5001/api/client-projects",
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${token}`,
    ...
    const fetchTeamLeads = async () => {
      try {
        ...
        const response = await fetch(
          "http://138.197.27.240:5001/api/client-projects/team-leads",
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
  ...
  //     const response = await fetch(`http://138.197.27.240:5001/api/client-projects/${selectedProject._id}/assign-team-lead`, {
  //       method: 'PUT',
  //       headers: {
  //         'Content-Type': 'application/json',
  //         'Authorization': `Bearer ${token}`
  ...
  const handleSaveAssignment = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://138.197.27.240:5001/api/client-projects/${selectedProject._id}/assign-team-lead`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const fetchEmployeesBySubRole = async (subRole) => {
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(
        `http://138.197.27.240:5001/api/client-projects/employees/sub-role/${subRole}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const handleAssignEmployee = async () => {
    ...
    const token = localStorage.getItem("token");
    await fetch(
      `http://138.197.27.240:5001/api/client-projects/${selectedProject._id}/assign-employee`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleSaveEmployees = async () => {
    ...
    const token = localStorage.getItem("token");
    await fetch(
      `http://138.197.27.240:5001/api/client-projects/${selectedProject._id}/assign-employees`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const updateProjectProgress = async (projectId, groupedTasks) => {
    try {
      ...
      const token = localStorage.getItem("token");
      await fetch(`http://138.197.27.240:5001/api/client-projects/${projectId}/progress`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const fetchAssignedProjects = async () => {
    try {
      const token = localStorage.getItem("token");
      const response = await fetch("http://138.197.27.240:5001/api/client-projects", {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
  ...
  const updateTask = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(`http://138.197.27.240:5001/tasks/${editTask._id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const saveAssignmentChanges = async () => {
    ...
    try {
      ...
      const token = localStorage.getItem("token");
      const response = await fetch(`http://138.197.27.240:5001/api/team-lead/tasks/${editTask._id}/assignment`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
