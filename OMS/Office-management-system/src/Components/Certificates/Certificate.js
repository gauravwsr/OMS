...
//       const response = await fetch("http://142.93.213.81:5000/api/offers", {
//         method: "GET",
//         headers: {
//           "Content-Type": "application/json",
//           "Authorization": `Bearer ${token}`,
...
const Certificate = () => {
  ...
  const checkExistingCertificates = async () => {
    try {
      ...
      console.log("Checking existing certificates...");
      const response = await fetch("http://142.93.213.81:5001/api/certificates", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const testAuthentication = async () => {
    try {
      ...
      // Test with a simple endpoint
      console.log("Testing authentication with offers endpoint...");
      const response = await fetch("http://142.93.213.81:5001/api/offers", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleCompletionSave = async () => {
    try {
      ...
      // Save to database via API - FIXED
      const response = await fetch("http://142.93.213.81:5001/api/completions", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      try {
        ...
        if (token) {
          ...
          const response = await fetch(
            "http://142.93.213.81:5001/api/completions",
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
