...
const Chat = () => {
  ...
  const API_BASE_URL = process.env.REACT_APP_API_URL || 'http://138.197.27.240:5001';
...
// const socket = io('http://138.197.27.240:5001'); // Connect to backend
...
//     const fetchMessages = async () => {
//       try {
//         const response = await axios.get('http://138.197.27.240:5001/api/messages', {
...
//     try {
//       const response = await axios.post('http://138.197.27.240:5001/api/messages', {
//         sender: loggedInUser,
...
//     try {
//       const response = await axios.delete(`http://138.197.27.240:5001/api/messages/${messageId}`);
